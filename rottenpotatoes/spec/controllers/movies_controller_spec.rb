...
RSpec.describe MoviesController, type: :controller do
  ...
  describe 'when trying to edit a movie' do
      it "updates the movie title" do
        movie = Movie.find(1)
        put :update, params: { id: movie.id, movie: { title: 'new_title' }  }
        movie.reload
  ...
  describe 'when trying to delete a movie' do
